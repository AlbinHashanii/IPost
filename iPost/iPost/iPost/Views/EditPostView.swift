            ...
            Section {
                ...
                HStack {
                    ...
                    Button("Submit"){
                        ...
                        showEditPostAlert = true
                    }
                    Spacer()
                }
            }
        }
        .alert(isPresented: $showEditPostAlert) {
            Alert(
                title: Text("Post Edited"),
                message: Text("Your post has been edited successfully."),
